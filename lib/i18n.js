...
const es = {
  ...
  'This website has never taken an order or a payment. If you paid someone for a Mriie Padel order that has not arrived, report it and you will get a personal reply.': 'Este sitio web nunca ha aceptado un pedido ni un pago. Si pagaste a alguien un pedido de Mriie Padel que no ha llegado, repórtalo y recibirás una respuesta personal.',
  'Orders are paused. Nothing can be bought, ordered, shipped or returned through this website, and no warranty or return claims exist against it.': 'Los pedidos están en pausa. No se puede comprar, pedir, enviar ni devolver nada a través de este sitio, y no existen reclamaciones de garantía o devolución contra él.',
  'Orders are paused, so there is nothing to ship. No delivery, pickup or courier service is offered through this website.': 'Los pedidos están en pausa, así que no hay nada que enviar. Este sitio no ofrece ningún servicio de entrega, recogida ni mensajería.',
  'Orders are paused. Because this website has never sold or shipped anything, there are no returns, refunds or guarantee claims to process here.': 'Los pedidos están en pausa. Como este sitio nunca ha vendido ni enviado nada, no hay devoluciones, reembolsos ni reclamaciones de garantía que procesar aquí.',
  'Partnerships suspended': 'Colaboraciones suspendidas',
  'We are not accepting wholesale orders, deposits or partnership enquiries. Do not pay a deposit to anyone offering Mriie Padel wholesale or club orders.': 'No aceptamos pedidos mayoristas, depósitos ni solicitudes de colaboración. No pagues ningún depósito a nadie que ofrezca pedidos mayoristas o para clubes de Mriie Padel.',
  'Trade Price List': 'Lista de precios mayoristas',
  'This price list is withdrawn. We are not accepting wholesale orders or deposits. Do not pay a deposit to anyone offering Mriie Padel wholesale.': 'Esta lista de precios ha sido retirada. No aceptamos pedidos mayoristas ni depósitos. No pagues ningún depósito a nadie que ofrezca Mriie Padel al por mayor.',
  'Shipping & Delivery': 'Envíos y entregas',
  'Returns & Guarantee': 'Devoluciones y garantía',
  'Handmade in Bali': 'Hecho a mano en Bali',
  'Thermal covers, court bags and linen towels in signature prints — each piece handmade by our artisans in Bali.': 'Fundas térmicas, bolsas de pista y toallas de lino en estampados exclusivos — cada pieza hecha a mano por nuestros artesanos en Bali.',
  'Every cover, bag and towel is cut and sewn by hand by our artisans in Bali — over 10,000 pieces so far, shipped to players in six countries.': 'Cada funda, bolsa y toalla se corta y cose a mano por nuestros artesanos en Bali — más de 10.000 piezas hasta ahora, enviadas a jugadores de seis países.',
  'Every piece comes in 20+ signature prints.': 'Cada pieza existe en más de 20 estampados exclusivos.',
  'Report': 'Reportar',
  'Thermal padel covers, bags and linen towels — handmade in Bali. Orders are paused.': 'Fundas de pádel térmicas, bolsas y toallas de lino — hechas a mano en Bali. Pedidos en pausa.',
  'Warning — do not send money': 'Advertencia — no envíes dinero',
  'Multiple buyers have reported paying for Mriie Padel orders through Instagram (@mriie.padl), WhatsApp or bank transfer and never receiving them. Do not pay anyone offering Mriie Padel products. This website is not taking orders and has never processed a payment. The matter is with lawyers and is the subject of a police report.': 'Varios compradores han denunciado haber pagado pedidos de Mriie Padel por Instagram (@mriie.padl), WhatsApp o transferencia bancaria sin recibirlos nunca. No pagues a nadie que ofrezca productos Mriie Padel. Este sitio web no acepta pedidos y nunca ha procesado un pago. El asunto está en manos de abogados y es objeto de una denuncia policial.',
  'If you paid and received nothing, report it now': 'Si pagaste y no recibiste nada, repórtalo ahora',
...
const id = {
  ...
  'This website has never taken an order or a payment. If you paid someone for a Mriie Padel order that has not arrived, report it and you will get a personal reply.': 'Situs ini tidak pernah menerima pesanan atau pembayaran. Jika Anda membayar seseorang untuk pesanan Mriie Padel yang belum sampai, laporkan dan Anda akan mendapat balasan pribadi.',
  'Orders are paused. Nothing can be bought, ordered, shipped or returned through this website, and no warranty or return claims exist against it.': 'Pemesanan dihentikan sementara. Tidak ada yang bisa dibeli, dipesan, dikirim, atau dikembalikan lewat situs ini, dan tidak ada klaim garansi atau retur terhadapnya.',
  'Orders are paused, so there is nothing to ship. No delivery, pickup or courier service is offered through this website.': 'Pemesanan dihentikan sementara, jadi tidak ada yang dikirim. Tidak ada layanan pengiriman, pengambilan, atau kurir lewat situs ini.',
  'Orders are paused. Because this website has never sold or shipped anything, there are no returns, refunds or guarantee claims to process here.': 'Pemesanan dihentikan sementara. Karena situs ini tidak pernah menjual atau mengirim apa pun, tidak ada retur, pengembalian dana, atau klaim garansi yang diproses di sini.',
  'Partnerships suspended': 'Kemitraan ditangguhkan',
  'We are not accepting wholesale orders, deposits or partnership enquiries. Do not pay a deposit to anyone offering Mriie Padel wholesale or club orders.': 'Kami tidak menerima pesanan grosir, uang muka, atau permintaan kemitraan. Jangan membayar uang muka kepada siapa pun yang menawarkan pesanan grosir atau klub Mriie Padel.',
  'Trade Price List': 'Daftar harga grosir',
  'This price list is withdrawn. We are not accepting wholesale orders or deposits. Do not pay a deposit to anyone offering Mriie Padel wholesale.': 'Daftar harga ini ditarik. Kami tidak menerima pesanan grosir atau uang muka. Jangan membayar uang muka kepada siapa pun yang menawarkan grosir Mriie Padel.',
  'Shipping & Delivery': 'Pengiriman',
  'Returns & Guarantee': 'Retur & garansi',
  'Handmade in Bali': 'Buatan tangan di Bali',
  'Thermal covers, court bags and linen towels in signature prints — each piece handmade by our artisans in Bali.': 'Sarung termal, tas lapangan, dan handuk linen dalam motif khas — setiap produk dibuat tangan oleh pengrajin kami di Bali.',
  'Every cover, bag and towel is cut and sewn by hand by our artisans in Bali — over 10,000 pieces so far, shipped to players in six countries.': 'Setiap sarung, tas, dan handuk dipotong dan dijahit tangan oleh pengrajin kami di Bali — lebih dari 10.000 produk sejauh ini, dikirim ke pemain di enam negara.',
  'Every piece comes in 20+ signature prints.': 'Setiap produk hadir dalam 20+ motif khas.',
  'Report': 'Lapor',
  'Thermal padel covers, bags and linen towels — handmade in Bali. Orders are paused.': 'Sarung padel termal, tas, dan handuk linen — buatan tangan di Bali. Pemesanan dihentikan sementara.',
  'Warning — do not send money': 'Peringatan — jangan kirim uang',
  'Multiple buyers have reported paying for Mriie Padel orders through Instagram (@mriie.padl), WhatsApp or bank transfer and never receiving them. Do not pay anyone offering Mriie Padel products. This website is not taking orders and has never processed a payment. The matter is with lawyers and is the subject of a police report.': 'Banyak pembeli melaporkan sudah membayar pesanan Mriie Padel lewat Instagram (@mriie.padl), WhatsApp, atau transfer bank tetapi tidak pernah menerimanya. Jangan membayar siapa pun yang menawarkan produk Mriie Padel. Situs ini tidak menerima pesanan dan tidak pernah memproses pembayaran. Kasus ini sudah ditangani pengacara dan telah dilaporkan ke polisi.',
  'If you paid and received nothing, report it now': 'Jika sudah bayar dan tidak menerima apa pun, laporkan sekarang',
