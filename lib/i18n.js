...
const es = {
  ...
  'We could not send your order — please try again or email us.': 'No pudimos enviar tu pedido — inténtalo de nuevo o escríbenos por correo.',
  ...
  'DHL Express worldwide from {currency}25 by region — 2–4 days to Southeast Asia, 4–7 to Europe. In Indonesia? Local courier at cost, or free self-collection in Bali.':
    'DHL Express mundial desde {currency}25 según región — 2–4 días al Sudeste Asiático, 4–7 a Europa. ¿En Indonesia? Mensajería local a precio de coste o recogida gratuita en Bali.',
}
...
const id = {
  ...
  'We could not send your order — please try again or email us.': 'Kami tidak bisa mengirim pesanan Anda — coba lagi atau email kami.',
  ...
  'DHL Express worldwide from {currency}25 by region — 2–4 days to Southeast Asia, 4–7 to Europe. In Indonesia? Local courier at cost, or free self-collection in Bali.':
    'DHL Express ke seluruh dunia mulai {currency}25 per wilayah — 2–4 hari ke Asia Tenggara, 4–7 ke Eropa. Di Indonesia? Kurir lokal sesuai ongkir, atau ambil sendiri gratis di Bali.',
}
